...
Sources for **mariospr.org**, a static site built with [Hugo](https://gohugo.io) (PaperMod theme),
migrated from WordPress. Everything lives in this repository.
...
The original source code and content of this repository are released under the
[MIT License](https://opensource.org/license/mit), see [COPYING](COPYING) for
details.

Third-party trademarks, logos, and brand assets (such as company names and logos
appearing in posts and pages) are the property of their respective owners, are
used for identification/nominative purposes only, and are **not** covered by the
MIT license; some embedded images and other media may likewise be owned by third
parties. The bundled [PaperMod](https://github.com/adityatelange/hugo-PaperMod)
theme (under `themes/PaperMod/`) is distributed under its own MIT license.
